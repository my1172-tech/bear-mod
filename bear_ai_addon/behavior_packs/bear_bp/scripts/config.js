...
/**
 * 窓の下端が、熊の足元から何ブロック上までなら入れるか。
 *
 * **ここを増やすと「壁を壊して入る」に化ける。** 統合版のモブが登れるのは
 * 1段まで。1のままにすること。
 *
 * 生成側は一軒家の窓を地面から3段目に置き、約45%の家だけ2段目にも広げる
 * (大窓)。つまり**入れるのは大窓の家とガラスビル**で、腰高窓の家は
 * 入口にならない。それでよい(全部の家に入れるほうが不自然)。
 */
